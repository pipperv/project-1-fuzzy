...
P_COG_600 = compute_plant('COG',600)
P_COG_720 = compute_plant('COG',720)
P_COG_850 = compute_plant('COG',850)

P_FOM_600 = compute_plant('FOM',600)
P_FOM_720 = compute_plant('FOM',720)
P_FOM_850 = compute_plant('FOM',850)

P_MOM_600 = compute_plant('MOM',600)
P_MOM_720 = compute_plant('MOM',720)
P_MOM_850 = compute_plant('MOM',850)
